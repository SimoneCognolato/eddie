...
class EtaPlusApiClientTest {
    ...
    @Test
    void fetchMeteredData_serverReturns429_throwsRateLimitException() {
    ...
    @Test
    void fetchMeteredData_serverReturns500_throwsEtaPlusServerException() {
    ...
    @Test
    void fetchMeteredData_serverReturns503_throwsEtaPlusServerException() {
    ...
    void fetchMeteredData_sendsRequestToCorrectEndpoint() throws InterruptedException {
        ...
        RecordedRequest recorded = takeLatestRequest();
        assertThat(recorded).isNotNull();
        assertThat(recorded.getPath()).startsWith("/api/meters/historical");
    }
    ...
    @Test
    void checkPermissionValidity_429Response_throwsRateLimitException() {
        server.enqueue(new MockResponse().setResponseCode(429));
